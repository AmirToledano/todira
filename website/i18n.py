...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    # ---------- home page ----------
    "home.eyebrow": {
        "he": "👑 חינם לגמרי · דרך טלגרם",
        "en": "👑 Completely free · via Telegram",
        "ru": "👑 Полностью бесплатно · через Telegram",
        "fr": "👑 Entièrement gratuit · via Telegram",
        "ar": "👑 مجاني بالكامل · عبر تيليجرام",
    },
    "home.h1": {
    ...
    "home.stat_free_value": {"he": "0 ₪", "en": "$0", "ru": "0 ₽", "fr": "0 €", "ar": "0 ₪"},
    ...
    "home.faq2_a": {
        "he": "טודירה סורק את שוק הדירות ברשת באופן אוטומטי כל 10 דקות ומשווה כל מודעה חדשה מול הסינון שלכם. עוד מקורות מתווספים בהדרגה.",
        "en": "Todira automatically scans the apartment market online every 10 minutes and compares every new listing against your filter. More sources are being added gradually.",
        "ru": "Todira автоматически сканирует рынок квартир в сети каждые 10 минут и сравнивает каждое новое объявление с вашим фильтром. Постепенно добавляются новые источники.",
        "fr": "Todira scanne automatiquement le marché des appartements en ligne toutes les 10 minutes et compare chaque nouvelle annonce à votre filtre. D'autres sources sont ajoutées progressivement.",
        "ar": "يفحص טודירה سوق الشقق على الإنترنت تلقائيًا كل 10 دقائق ويقارن كل إعلان جديد بفلترك. تُضاف مصادر إضافية تدريجيًا.",
    },
    "home.faq3_q": {
        "he": "זה באמת בחינם?", "en": "Is it really free?", "ru": "Это правда бесплатно?",
        "fr": "Est-ce vraiment gratuit ?", "ar": "هل هو مجاني فعلاً؟",
    },
    "home.faq3_a": {
        "he": "כן, כרגע השירות חינמי לגמרי.",
        "en": "Yes, the service is currently completely free.",
        "ru": "Да, сейчас сервис полностью бесплатный.",
        "fr": "Oui, le service est actuellement entièrement gratuit.",
        "ar": "نعم، الخدمة مجانية بالكامل حاليًا.",
    },
    "home.faq4_q": {
